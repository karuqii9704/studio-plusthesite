...
export const InteractiveTour: React.FC<{ steps?: TourStep[], isActive: boolean, onComplete: () => void }> = ({ steps, isActive, onComplete }) => {
    ...
    return (
        <div className="fixed inset-0 z-[70] pointer-events-none">
            ...
            <div className="absolute border-2 border-brand rounded-lg shadow-[0_0_30px_rgba(255,255,255,0.8)] animate-pulse" style={{ top: position.targetTop - 4, left: position.targetLeft - 4, width: position.width + 8, height: position.height + 8 }}></div>
